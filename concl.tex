...
Atingiu-se portanto o objetivo geral do trabalho visto que através da utilização de um sistema de redes neurais o sistema desenvolvido foi capaz de classificar os objetos metálicos testados com $100\%$ de acerto e foi capaz de medir o ângulo de rotação com erro médio de $1.2^o$.
%3 Objetivos: geral
