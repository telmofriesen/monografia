...
Portanto, para o cálculo do valor limiar pelo método de \emph{Otsu} basta encontrar o valor limiar $t$ tal que q variância entre as classes, $\sigma _{B}^{2} (t)$, é máximo. A dedução da equação \ref{eq:fundteor_otsu} está fora do escopo deste projeto, mas pode ser encontrada em \cite{GONZALEZ-2006}. 
...
Vê-se portanto que é possível definir um eixo absoluto para cada imagem com base na distribuição dos pixeis sobre a imagem.
