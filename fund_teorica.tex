...
Pode-se demonstrar que o autovetor associado ao maior autovalor de uma matriz de covariâncias aponta na direção de maior variação dos dados \cite{AUTOVETORES-DEDUCAO}. Considere por exemplo as imagens da figura \ref{fig:fundteor_pca}....
