...
Caso a função de ativação escolhida seja a função sigmoide, equação \ref{eq:fundteor_nn_perceptron_error_multi_sig}, a derivada $h'_{j}$ é dada pela equação \ref{eq:fundteor_nn_perceptron_error_multi_desc_5}.

\begin{equation}
h(I_{j}) = 
\label{eq:fundteor_nn_perceptron_error_multi_sig}
\end{equation}
