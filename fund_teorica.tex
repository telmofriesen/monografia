...
Esta seção apresenta técnicas e algoritmos para realizar a descrição de imagens, tais como propriedades básicas de regiões e descritores de \emph{fourier}.


\subsection{Propriedades de regiões}


%'Area', 'ConvexArea', 'Eccentricity', 'EulerNumber', 'Extent', 'FilledArea', 'MajorAxisLength', 'MinorAxisLength', 'Solidity'
