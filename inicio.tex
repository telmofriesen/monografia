...
\palavraschave{Processamento de Imagens, Classificação de Objetos, Reconhecimento de Padrões, Aprendizagem de Máquina, Rede Neural, Análise de Componentes Principais, Descritores de Fourier } % palavras-chave do trabalho
\keywords{Image Processing, Object Classification, Pattern Recognition, Machine Learning, Neural Network, Principal Components Analysis, Fourier Descriptors} % palavras-chave do trabalho em ingles
