...
Como dito na seção \ref{sub:fundteor_normalizacao}, o autovetor associado ao maior autovalor da matriz de covariâncias dos pixels da imagem aponta na direção de maior variação dos dados. 
